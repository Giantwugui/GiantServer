...
namespace Giant.Msg
{
	public static partial class OuterOpcode
	{
		 ...
		 public const ushort Msg_GC_HeartBeat_Pong = 111;
		 public const ushort Msg_GC_Get_SecretKey = 112;
		 public const ushort Msg_GC_CreateCharacter = 113;
		 public const ushort Msg_CharacterInfo = 114;
		 public const ushort Msg_GC_GetCharacter = 115;
		 public const ushort Msg_GC_Login = 116;
		 public const ushort Msg_PlayerInfo = 117;
		 public const ushort Msg_CG_EnterMap = 118;
		 public const ushort Msg_GC_EnterMap = 119;
		 public const ushort Msg_UnitInfo = 120;
		 public const ushort Msg_MC_PathfindingResult = 121;
		 public const ushort CM_Reload = 122;
		 public const ushort MC_Reload = 123;
		 public const ushort ZGC_Broadcast = 124;
		 public const ushort Msg_CG_TestMap = 125;
