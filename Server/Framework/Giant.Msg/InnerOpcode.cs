...
namespace Giant.Msg
{
	public static partial class InnerOpcode
	{
		 ...
		 public const ushort Msg_MGate_BalanceZone = 1005;
		 public const ushort Msg_Service_Info = 1006;
		 public const ushort Msg_HeartBeat_Ping = 1007;
		 public const ushort Msg_HeartBeat_Pong = 1008;
		 public const ushort Msg_RegistService_Req = 1009;
		 public const ushort Msg_RegistService_Rep = 1010;
		 public const ushort Msg_RG_GetLoginKey = 1011;
		 public const ushort Msg_GetLoginKey = 1012;
