...
namespace Server.App
{
    ...
    {
        public override async void Run(Session session, CR_Login request, RC_Login response)
        {
    ...
    {
        public override void Run(Session session, CR_Ping request, RC_Ping response)
        {
            response.Error = ErrorCode.Success;
        }
    }
