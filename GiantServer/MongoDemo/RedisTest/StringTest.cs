...
namespace Redis.HelperTest
{
    ...
    public class StringTest
    {
        ...
        public void TestStringAction()
        {
            ...
            Assert.IsTrue(redis.StringSet<UserModel>("Test_Object", new UserModel { Id = 1, UserName = "Giant", Age = 33 }));
            ...
            var strValue = redis.StringGet("Test_String");

            Assert.AreEqual("Test_String", strValue);
        ...
        public async Task TestStringAsync()
        {
            ...
            Assert.IsTrue(await redis.StringSetAsync<UserModel>("Test_Object", new UserModel { Id = 1, UserName = "Giant", Age = 3 }));
            Assert.IsTrue(await redis.StringSetAsync<UserModel>("Test_Object1", new UserModel { Id = 2, UserName = "GT", Age = 3 }));
            ...
            Assert.AreEqual(2, (await redis.StringGetSetAsync<UserModel>("Test_Object1", new UserModel { Id = 2, UserName = "Giant_new", Age = 33 })).Id);
