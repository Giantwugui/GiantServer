...
namespace ETTools
{
    ...
    public static class Program
    {
        ...
        private static string csharpPath = "../Server/Giant.Msg/";
        ...
        public static void Main(string[] args)
        {
            ...
            if (args.Length != 0)
            {
                ...
                csharpPath = $"{args[0]}../Server/Giant.Msg/";
            }
    ...
    {
        private const string protoPath = "../Server/Giant.Msg/Proto/";
        private const string serverMessagePath = "../Server/Giant.Msg/";
        private static readonly char[] splitChars = { ' ', '\t' };
        private static readonly List<OpcodeInfo> msgOpcode = new List<OpcodeInfo>();
